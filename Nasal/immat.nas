...
# ===========================
# set each /sim/multiplay/generic/int[] value to the "/sim/multiplay/callsign" string.
# then each int[n] value is taken from callsign.xml
...
var immat_dialog = gui.Dialog.new("/sim/gui/dialogs/Bell-412/status/dialog", "Aircraft/Bell-412/Dialogs/immat.xml");
