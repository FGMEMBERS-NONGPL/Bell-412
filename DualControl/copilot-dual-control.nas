...
var connect = func (pilot) {
  ...
  print("[Bell-412] X Dual control ... connected to pilot.");
...
var main = {
  ...
  init : func {
    ...
    me.active = 0;
    print("[Bell-412] X Copilot dual control ... initialized");
    settimer(func { me.activate(); }, 5);
  },
  reset : func {
    if (me.active) {
      print("[Bell-412] X Dual control ... disconnected from pilot.");
      disconnect();
      ...
      if ((pilot.getChild("valid").getValue()) and
        ...
        if (me.active == 0) {
          ...
          if ((pilot.getNode("sim/model/path") != nil) and
            ...
            print("[Bell-412] X Dual control ... pilot rejected - wrong aircraft type.");
            me.loopid += 1;
            return;
          }
        }
