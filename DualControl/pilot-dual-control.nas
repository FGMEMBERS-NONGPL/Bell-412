...
var connect = func (copilot) {
  ...
  print("[Bell-412] X Dual control ... copilot connected.");
...
var main = {
  ...
  init : func {
    ...
    print("[Bell-412] X Pilot dual control ... initialized");
  },
  reset : func {
    if (me.active) {
      print("[Bell-412] X Dual control ... copilot disconnected.");
  ...
  update : func {
    ...
    foreach (var copilot; mpplayers) {
      if ((copilot.getChild("valid").getValue()) and
		  ...
		  #print("==> DEBUG:pilot-dual-control::main.update()" ~ r_callsign);
        ...
        if (me.active == 0) {
          ...
          if ((copilot.getNode("sim/model/path") != nil) and
            ...
            print("[Bell-412] X Dual control ... copilot rejected - wrong aircraft type.");
            me.loopid += 1;
            return;
          }
        }
